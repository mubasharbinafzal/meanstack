      ...
      auth: {
          ...
          //  api_user: 'mubashar1',
           // api_key: 'Chaudhary391'
            api_user: 'meanstackdevelpoer',
            api_key: 'developerno1'
               ...
               if (err){
                   console.log(err);
                         ...
                         var email = {
                          ...
                          html: 'Hello <strong>'+user.username+'</strong>,<br><br>you recently request a new activation link. please click on the link below to complete your activation :<br><br> <a href="http://localhost:8080/activate/'+user.temporarytoken+ '">http://localhost:8080/activate/</a>'
                        };
                        client.sendMail(email, function(err, info){
                            if (err){
                              console.log(err);
